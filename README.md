...
**[Conheça a página e explore os cenários ↗](https://brunoflma.github.io/claude-session-linker/)** · [Instalar com ajuda de IA](https://brunoflma.github.io/claude-session-linker/#instalar) · [Baixar a última release](https://github.com/brunoflma/claude-session-linker/releases/latest) · [Guia Windows](https://brunoflma.github.io/claude-session-linker/install-windows.html) · [Guia macOS](https://brunoflma.github.io/claude-session-linker/install-macos.html)
...
| Sistema | Setup no pacote do sistema | Passo a passo |
| :--- | :--- | :--- |
...
1. Abra a [última release](https://github.com/brunoflma/claude-session-linker/releases/latest) e baixe o ZIP de Windows ou macOS.
